    ...
    var d = {},
      ...
      q = (l.BufferedBlockAlgorithm = t.extend({
        ...
        mI8A: function (a) {
          ...
          j = u.min(4 * a, j)
          if (a) {
            for (var q = 0; q < a; q += k) this.tq0x(e, q)
            q = e.splice(0, a)
            c.sigBytes -= j
          }
    ...
    d.BlockCipher = v.extend({
      ...
      reset: function () {
        ...
        var a = this.cfg,
          b = a.iv,
          a = a.mode
        if (this.WF4J == this.FT4X) var c = a.createEncryptor
        else (c = a.createDecryptor), (this.WB4F = 1)
...
!(function () {
  ...
  ;(mockWindow.asrsea = d), (mockWindow.ecnonasr = e)
})()

/**
 * 网易云音乐接口数据加密函数
 * @param {object} reqData 接口请求的参数
 */
exports.getNeteaseReqEncryptionData = reqData => {
  var bVg1x = mockWindow.asrsea(
  ...
  return {
    params: bVg1x.encText,
    encSecKey: bVg1x.encSecKey
  }
}
